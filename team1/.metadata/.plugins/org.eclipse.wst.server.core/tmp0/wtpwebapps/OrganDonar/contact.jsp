    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2>Contact Information</h2>
                <p>Donec at diam non mauris adipiscing tempus. Nam congue turpis quis purus cursus suscipit. Nullam tempor eleifend interdum. Validate <a href="http://validator.w3.org/check?uri=referer" rel="nofollow"><strong>XHTML</strong></a> and <a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow"><strong>CSS</strong></a>.</p>
        </div>
        ...
        <div id="tooplate_content">
        	...
        	<div class="content_box">
                ...
                <h6><strong>Location Two</strong></h6>
                    990-330 Mauris mattis posuere nunc, <br />
                    Vivamus accumsan convallis, 11800<br />
                    Etiam nulla bibendum<br /><br />
                    Phone: 010-030-2500 <br />
                    Email: <a href="mailto:info@company.com">info@company.com</a> 
                </div>
