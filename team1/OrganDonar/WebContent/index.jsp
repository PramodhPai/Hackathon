...
<div id="tooplate_wrapper">
	...
	<div id="tooplate_sidebar">
		<div id="site_title1">
			<img src="images/organ/logo1.jpg" width="100" height="150"  /><br></br>
	</div>
    ...
    <div id="tooplate_main">
        ...
        <div id="featured_project">
        	...
        	<img src="images/organ/organ1.jpg" alt="Feature 01" />
        	<h3>Organ Donation</h3>
            <p>A donation is where a person donates their organs and tissues for transplant.

A transplant can save a person's life or improve their health and quality of life.</p>
            <a href="#">Read more</a>
        </div> <!-- end of featured project -->
        
        <div id="tooplate_content">
        	<div class="col_w300 float_l">
            	<h2>Organ Donation Summary</h2>
                <p><em>Organ donation takes healthy organs and tissues from one person for transplantation into another. Experts say that the organs from one donor can save or help as many as 50 people. Organs you can donate include</p>
            <ul>
...
<p>Most organ and tissue donations occur after the donor has died. But some organs and tissues can be donated while the donor is alive.</p>
            ...
            <div class="col_w300 float_r">
                ...
                <div class="home_newsbox">
                    <img src="images/organ/index1.jpg" width="50" height="50" alt="Image 02" class="image_wrapper image_fl" />
                ...
                <div class="home_newsbox">
                  <img src="images/organ/registerasorgandonor.jpg" width="50" height="50" alt="Image 03" class="image_wrapper image_fl" />
